  ...
  return (
    ...
    >
      ...
      <div
        style={{
          flex: "0 0 45%",
          background: "linear-gradient(155deg, hsl(215 85% 18%) 0%, hsl(215 85% 28%) 50%, hsl(210 90% 38%) 100%)",
          display: "flex",
      ...
      >
        ...
        <div style={{
          ...
          background: "linear-gradient(180deg, hsl(35 95% 55%), hsl(25 95% 50%))",
        }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "64px" }}>
          ...
          <div>
            ...
            <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "12px", letterSpacing: "0.5px", textTransform: "uppercase", fontFamily: "system-ui, sans-serif" }}>
              Inspecciones
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "hsl(215 16% 57%)", display: "flex",
                  }}
            ...
            <button
              ...
              style={{
                ...
                background: loading
                  ? "hsl(215 85% 45%)"
                  : "linear-gradient(135deg, hsl(215 85% 25%), hsl(210 90% 38%))",
                color: "white",
                border: "none",
                borderRadius: "10px",
                fontSize: "15px",
